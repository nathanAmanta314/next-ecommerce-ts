      ...
      {productOptions.map((option) => (
        <div className="flex flex-col gap-4" key={option.name}>
          ...
          <ul className="flex items-center gap-3">
            {option.choices?.map((choice: products.Choice) => {
              ...
              return option.name === "Color" ? (
                ...
                >
                  {selected && (
                    <div className="absolute w-10 h-10 rounded-full ring-2 top-1/2 left-1/2 transform -translate-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                  )}
                  {disabled && (
                    <div className="absolute w-10 h-[2px] bg-red-400 rotate-45 top-1/2 left-1/2 transform -translate-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                  )}
                </li>
              ) : (
                <li
